...
var isOpen = function (client) { return client.readyState === ws_1.default.OPEN; };
...
exports.createWss = function (serverOrPort, options) {
    ...
    var args = {};
    if (serverOrPort instanceof http_1.default.Server) {
    ...
    var wss = new ws_1.default.Server(args);
