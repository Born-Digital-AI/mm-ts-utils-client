...
exports.createCloseWssIf = function () {
    ...
    var closeWssIf = function (_wss, condition, done) {
        if (!_wss) {
            ...
            _wss.close(function (err) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            _closeWssIfTimer = setTimeout(function () { return closeWssIf(_wss, condition, done); }, 10);
        }
    };
    return closeWssIf;
};
exports.createDoneIf = function () {
    ...
    var doneIf = function (condition, done) {
        if (condition()) {
            ...
            _doneIfTimer = setTimeout(function () { return doneIf(condition, done); }, 10);
        }
    };
    return doneIf;
};
